...
class Enemy(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.rect.x == x + 170 and self.rect.y == y:  # Если вражеский персонаж находится на оптимальных для стрельбы к.
            ...
            if self.rect.x == x + 210 or self.rect.y == y + 35 or self.rect.x == x - 210 or self.rect.y == y - 35:
        ...
        if self.enemy_is_near:
            ...
            if len(bullets_enemy) <= 1:
                bullets_enemy.append(shooting_enemy(round(self.rect.x),
                                               round(self.rect.y + 30), 2, (0, 0, 0), facing))
        else:  # Если вражеский персонаж не находится на оптимальных для стрельбы координатах
            if self.rect.x != x + 170 or self.rect.y != y:
                ...
                if self.rect.x != x + 170 and self.rect.y != y:
                    ...
                    elif self.rect.x < x + 170 and self.rect.y < y:
                        self.left_enemy = False
