...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        ...
        self.image = pygame.transform.scale(load_image('player_stand.png'), (34, 52))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x_enemy, y_enemy, speed):
        ...
        self.left_enemy, self.right_enemy, self.down_enemy, self.up_enemy = False, False, False, False
        self.animation = [False, False, False, False, False]  # left, right, down, up, enemy_is_near
        self.flag, self.health = False, 3
        self.animation_count = 0
